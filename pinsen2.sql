...
--
-- Host: localhost
-- Generation Time: 2015-09-18 17:31:19
-- 服务器版本： 5.6.21
-- PHP Version: 5.5.19
...
--
-- 插入之前先把表清空（truncate） `ts_action`
--

TRUNCATE TABLE `ts_action`;
--
-- 转存表中的数据 `ts_action`
--
...
--
-- 插入之前先把表清空（truncate） `ts_action_log`
--

TRUNCATE TABLE `ts_action_log`;
--
...
(30, 1, 1, 1884956097, 'member', 1, '操作url：/index.php?s=/admin/public/login.html', 1, 1442590057);
...
--
-- 插入之前先把表清空（truncate） `ts_activity`
--

TRUNCATE TABLE `ts_activity`;
--
-- 转存表中的数据 `ts_activity`
--
...
--
-- 插入之前先把表清空（truncate） `ts_addons`
--

TRUNCATE TABLE `ts_addons`;
--
-- 转存表中的数据 `ts_addons`
--
...
DROP TABLE IF EXISTS `ts_advertise`;
...
--
-- 插入之前先把表清空（truncate） `ts_advertise`
--

TRUNCATE TABLE `ts_advertise`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_attachment`
--

TRUNCATE TABLE `ts_attachment`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_attribute`
--

TRUNCATE TABLE `ts_attribute`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_auth_extend`
--

TRUNCATE TABLE `ts_auth_extend`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_auth_group`
--

TRUNCATE TABLE `ts_auth_group`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_auth_group_access`
--

TRUNCATE TABLE `ts_auth_group_access`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_auth_rule`
--

TRUNCATE TABLE `ts_auth_rule`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_category`
--

TRUNCATE TABLE `ts_category`;
--
-- 转存表中的数据 `ts_category`
--
...
--
-- 插入之前先把表清空（truncate） `ts_channel`
--

TRUNCATE TABLE `ts_channel`;
--
-- 转存表中的数据 `ts_channel`
--
...
--
-- 插入之前先把表清空（truncate） `ts_config`
--

TRUNCATE TABLE `ts_config`;
--
-- 转存表中的数据 `ts_config`
--
...
--
-- 插入之前先把表清空（truncate） `ts_course`
--

TRUNCATE TABLE `ts_course`;
--
-- 转存表中的数据 `ts_course`
--
...
DROP TABLE IF EXISTS `ts_course_comment`;
...
--
-- 插入之前先把表清空（truncate） `ts_course_comment`
--

TRUNCATE TABLE `ts_course_comment`;
--
...
DROP TABLE IF EXISTS `ts_course_record`;
...
--
-- 插入之前先把表清空（truncate） `ts_course_record`
--

TRUNCATE TABLE `ts_course_record`;
--
...
DROP TABLE IF EXISTS `ts_course_type`;
...
--
-- 插入之前先把表清空（truncate） `ts_course_type`
--

TRUNCATE TABLE `ts_course_type`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_document`
--

TRUNCATE TABLE `ts_document`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_document_article`
--

TRUNCATE TABLE `ts_document_article`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_document_download`
--

TRUNCATE TABLE `ts_document_download`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_drug`
--

TRUNCATE TABLE `ts_drug`;
--
-- 转存表中的数据 `ts_drug`
--
...
DROP TABLE IF EXISTS `ts_drug_store`;
...
--
-- 插入之前先把表清空（truncate） `ts_drug_store`
--

TRUNCATE TABLE `ts_drug_store`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_exam`
--

TRUNCATE TABLE `ts_exam`;
--
-- 转存表中的数据 `ts_exam`
--
...
DROP TABLE IF EXISTS `ts_exam_options`;
...
--
-- 插入之前先把表清空（truncate） `ts_exam_options`
--

TRUNCATE TABLE `ts_exam_options`;
--
...
DROP TABLE IF EXISTS `ts_exam_question`;
...
--
-- 插入之前先把表清空（truncate） `ts_exam_question`
--

TRUNCATE TABLE `ts_exam_question`;
--
...
DROP TABLE IF EXISTS `ts_exam_survey`;
...
--
-- 插入之前先把表清空（truncate） `ts_exam_survey`
--

TRUNCATE TABLE `ts_exam_survey`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `ts_exam_survey_detl`;
...
--
-- 插入之前先把表清空（truncate） `ts_exam_survey_detl`
--

TRUNCATE TABLE `ts_exam_survey_detl`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_file`
--

TRUNCATE TABLE `ts_file`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `ts_gift_record`;
...
--
-- 插入之前先把表清空（truncate） `ts_gift_record`
--

TRUNCATE TABLE `ts_gift_record`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_hooks`
--

TRUNCATE TABLE `ts_hooks`;
--
-- 转存表中的数据 `ts_hooks`
--
...
DROP TABLE IF EXISTS `ts_kejian`;
...
--
-- 插入之前先把表清空（truncate） `ts_kejian`
--

TRUNCATE TABLE `ts_kejian`;
--
-- 转存表中的数据 `ts_kejian`
--
...
--
-- 插入之前先把表清空（truncate） `ts_member`
--

TRUNCATE TABLE `ts_member`;
--
-- 转存表中的数据 `ts_member`
--
...
(1, 'Administrator', 0, '0000-00-00', '', 110, 0, 23, 0, 1433383014, 1884956097, 1442590057, 1, '', '', '', 0, 0, 0),
...
--
-- 插入之前先把表清空（truncate） `ts_menu`
--

TRUNCATE TABLE `ts_menu`;
--
-- 转存表中的数据 `ts_menu`
--
...
--
-- 插入之前先把表清空（truncate） `ts_order`
--

TRUNCATE TABLE `ts_order`;
--
-- 转存表中的数据 `ts_order`
--
...
DROP TABLE IF EXISTS `ts_pharma`;
...
--
-- 插入之前先把表清空（truncate） `ts_pharma`
--

TRUNCATE TABLE `ts_pharma`;
--
-- 转存表中的数据 `ts_pharma`
--
...
--
-- 插入之前先把表清空（truncate） `ts_picture`
--

TRUNCATE TABLE `ts_picture`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_port`
--

TRUNCATE TABLE `ts_port`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_port_category`
--

TRUNCATE TABLE `ts_port_category`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_port_value`
--

TRUNCATE TABLE `ts_port_value`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `ts_subbranch`;
...
--
-- 插入之前先把表清空（truncate） `ts_subbranch`
--

TRUNCATE TABLE `ts_subbranch`;
--
...
--
-- 插入之前先把表清空（truncate） `ts_ucenter_admin`
--

TRUNCATE TABLE `ts_ucenter_admin`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_ucenter_app`
--

TRUNCATE TABLE `ts_ucenter_app`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_ucenter_member`
--

TRUNCATE TABLE `ts_ucenter_member`;
--
...
(1, 'Administrator', '61e583a0bc8d881e9c8dec32ed735881', 'tanggsh@163.com', '', 1433383014, 2130706433, 1442590057, 1884956097, 1433383014, 1),
...
--
-- 插入之前先把表清空（truncate） `ts_ucenter_setting`
--

TRUNCATE TABLE `ts_ucenter_setting`;
-- --------------------------------------------------------
...
--
-- 插入之前先把表清空（truncate） `ts_url`
--

TRUNCATE TABLE `ts_url`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `ts_user_focus`;
...
--
-- 插入之前先把表清空（truncate） `ts_user_focus`
--

TRUNCATE TABLE `ts_user_focus`;
--
...
DROP TABLE IF EXISTS `ts_yaochang`;
...
--
-- 插入之前先把表清空（truncate） `ts_yaochang`
--

TRUNCATE TABLE `ts_yaochang`;
--
-- 转存表中的数据 `ts_yaochang`
--
...
DROP TABLE IF EXISTS `ts_yaodian`;
...
--
-- 插入之前先把表清空（truncate） `ts_yaodian`
--

TRUNCATE TABLE `ts_yaodian`;
--
-- 转存表中的数据 `ts_yaodian`
--
...
--
ALTER TABLE `ts_action_log`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',AUTO_INCREMENT=31;
--
