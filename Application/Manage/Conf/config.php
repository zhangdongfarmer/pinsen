...
return array(
    /* 数据缓存设置 */
    'DATA_CACHE_PREFIX'    => 'produce_', // 缓存前缀
    'DATA_CACHE_TYPE'      => 'produceFile', // 数据缓存类型

    /* 文件上传相关配置 */
    'DOWNLOAD_UPLOAD' => array(
        'mimes'    => '', //允许上传的文件MiMe类型
        'maxSize'  => 50*1024*1024, //上传的文件大小限制 (0-不做限制)
        'exts'     => 'jpg,gif,png,jpeg,zip,rar,tar,gz,7z,doc,docx,txt,xml,flv,mp4,rmvb,rm,avi,swf', //允许上传的文件后缀
