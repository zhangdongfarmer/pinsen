 ...
 * @date 2015-06-14
 */
class PharmaController extends \Admin\Controller\AdminController {
    ...
    public function index(){
        $list = $this->lists('Pharma');
        $this->assign('list', $list);
        $this->meta_title = '药厂管理';
        $this->display();
    }
    public function add(){
        $id = I('get.id','');
        ...
        if($id){
            ...
            $this->meta_title = '修改药厂';
        }else{
            
            $this->meta_title = '新增药厂';
        }
        $this->display();
    }
